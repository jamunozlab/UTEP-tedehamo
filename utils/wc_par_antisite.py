...
def wc_parms(input_files_dict,nneigh,atom_type1,atom_type2):
    nn = len(nneigh) - 1
    {atom_type1}{atom_type2}_params = {}
    {atom_type1}{atom_type1}_params = {}
    {atom_type2}{atom_type1}_params = {}
    {atom_type2}{atom_type2}_params = {}
    
    for conc, defects, files in input_files_dict.items():
        {atom_type1}{atom_type2}_params[conc] = []
        {atom_type1}{atom_type1}_params[conc] = []
        {atom_type2}{atom_type1}_params[conc] = []
        {atom_type2}{atom_type2}_params[conc] = []
